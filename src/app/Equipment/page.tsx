    ...
    <div className={styles.container}>
      ...
      <div className={styles.box1}>
        <div className={styles.overlay}>
          <p className={styles.title}>{activeTab}</p> {/* Dynamically update title */}
        </div>
      </div>
      ...
      <div className={styles.box2}>
        ...
        <p className={styles.title2box2}>for {activeTab}</p> {/* Dynamically update subheading */}
      ...
      <Box3 onTabChange={handleTabChange} /> {/* Pass callback as prop */}
      <GalleryBox />
    </div>
  );
};
